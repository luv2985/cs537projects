...
{    
  ...
  2b:	50                   	push   %eax
  2c:	68 3f 07 00 00       	push   $0x73f
        argv[0] = "getfilename";
  31:	c7 45 f0 40 07 00 00 	movl   $0x740,-0x10(%ebp)
        argv[1] = "README";
  38:	c7 45 f4 38 07 00 00 	movl   $0x738,-0xc(%ebp)
        exec("/getfilename", argv);
  3f:	e8 a7 02 00 00       	call   2eb <exec>
        exit();
  44:	e8 6a 02 00 00       	call   2b3 <exit>
        wait();
  49:	e8 6d 02 00 00       	call   2bb <wait>
        exit();
