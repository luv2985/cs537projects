  ...
  15:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  31:	8d 9d f8 fe ff ff    	lea    -0x108(%ebp),%ebx
  int f = open(argv[1], 0);
  37:	52                   	push   %edx
  38:	6a 00                	push   $0x0
  3a:	ff 70 04             	push   0x4(%eax)
  3d:	e8 c1 02 00 00       	call   303 <open>
  getfilename(f, name, 256);
  42:	83 c4 0c             	add    $0xc,%esp
  45:	68 00 01 00 00       	push   $0x100
  4a:	53                   	push   %ebx
  4b:	50                   	push   %eax
  4c:	e8 12 03 00 00       	call   363 <getfilename>
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 98 07 00 00 	jmp    *0x798(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 8f 07 00 00       	mov    $0x78f,%edx
        while(*s != 0){
