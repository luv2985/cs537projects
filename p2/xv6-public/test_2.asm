...
{    
  ...
  10:	53                   	push   %ebx
    char message[256] = {"\0"};
  11:	8d bd ec fe ff ff    	lea    -0x114(%ebp),%edi
{    
  17:	51                   	push   %ecx
    char message[256] = {"\0"};
  18:	b9 3f 00 00 00       	mov    $0x3f,%ecx
{    
  1d:	81 ec 14 01 00 00    	sub    $0x114,%esp
    char message[256] = {"\0"};
  23:	c7 85 e8 fe ff ff 00 	movl   $0x0,-0x118(%ebp)
  2a:	00 00 00 
  2d:	f3 ab                	rep stos %eax,%es:(%edi)
    int fd1 = open("README",O_RDONLY);
  2f:	6a 00                	push   $0x0

    if(getfilename(fd1, message, 256) != 0)
  31:	8d bd e8 fe ff ff    	lea    -0x118(%ebp),%edi
    int fd1 = open("README",O_RDONLY);
  37:	68 58 07 00 00       	push   $0x758
  3c:	e8 d2 02 00 00       	call   313 <open>
    if(getfilename(fd1, message, 256) != 0)
  41:	83 c4 0c             	add    $0xc,%esp
  44:	68 00 01 00 00       	push   $0x100
    int fd1 = open("README",O_RDONLY);
  49:	89 c3                	mov    %eax,%ebx
    if(getfilename(fd1, message, 256) != 0)
  4b:	57                   	push   %edi
  4c:	50                   	push   %eax
  4d:	e8 21 03 00 00       	call   373 <getfilename>
  ...
  5e:	50                   	push   %eax
  5f:	57                   	push   %edi
  60:	68 60 07 00 00       	push   $0x760
  65:	6a 01                	push   $0x1
  67:	e8 c4 03 00 00       	call   430 <printf>
    close(fd1);
  6c:	89 1c 24             	mov    %ebx,(%esp)
  6f:	e8 87 02 00 00       	call   2fb <close>
    exit();  
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 83 07 00 00       	mov    $0x783,%edx
        while(*s != 0){
