   ...
   7:	31 c0                	xor    %eax,%eax
{
  ...
  10:	51                   	push   %ecx
    char message[256] = {"\0"};
  11:	8d bd fc fe ff ff    	lea    -0x104(%ebp),%edi
  17:	b9 3f 00 00 00       	mov    $0x3f,%ecx
{
  1c:	81 ec 04 01 00 00    	sub    $0x104,%esp
    char message[256] = {"\0"};
  22:	c7 85 f8 fe ff ff 00 	movl   $0x0,-0x108(%ebp)
  29:	00 00 00 
  2c:	f3 ab                	rep stos %eax,%es:(%edi)
    int fd1 = -2;
    int retVal = getfilename(fd1, message, 256); 
  2e:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  34:	68 00 01 00 00       	push   $0x100
  39:	50                   	push   %eax
  3a:	6a fe                	push   $0xfffffffe
  3c:	e8 12 03 00 00       	call   353 <getfilename>
    printf(1,"XV6_TEST_OUTPUT Open filename: %d\n", retVal);
  41:	83 c4 0c             	add    $0xc,%esp
  44:	50                   	push   %eax
  45:	68 38 07 00 00       	push   $0x738
  4a:	6a 01                	push   $0x1
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 64 07 00 00 	jmp    *0x764(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 5b 07 00 00       	mov    $0x75b,%edx
        while(*s != 0){
